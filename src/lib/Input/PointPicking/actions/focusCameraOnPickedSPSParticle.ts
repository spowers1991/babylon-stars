...
export function focusCameraOnPickedSPSParticle(
  scene: BABYLON.Scene,
  camera: BABYLON.Camera,
  particlesInstance: BABYLON.SolidParticleSystem
) {
  ...
  scene.onPointerObservable.add((pointerInfo) => {
    ...
    if (!particlesInstance.particles || particlesInstance.particles.length === 0) {
    ...
    let closestParticle: BABYLON.SolidParticle | null = null;
